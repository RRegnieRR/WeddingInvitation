...
export const content = {
  en: {
    ...
    rsvp: {
      ...
      honeypot: "Website",
      codeTitle: "Open your personal invitation",
      codeHelp: "Use the invitation code included in the message we sent you.",
      codeLabel: "Invitation code",
      codeSubmit: "Open invitation",
      loading: "Loading your invitation…",
      loadError: "We could not load this invitation.",
      saveError: "We could not save your RSVP.",
      invitationFor: "Invitation for",
      spacesReserved: "We have reserved {count} places for you.",
      spacesUsed: "{used} of {max} places",
      editHelp: "You can update your answer until the RSVP deadline.",
      attendanceLabel: "Attendance",
      attendanceYes: "Yes, I’ll be there",
      attendanceNo: "Unfortunately, I can’t make it",
      whoAttends: "Who will attend?",
      guest: "Guest",
      name: "Name",
      email: "Email",
      emailPlaceholder: "Optional",
      dietary: "Dietary requirements",
      dietaryPlaceholder: "Allergies or dietary needs",
      isChild: "This guest is a child",
      message: "Message for the couple",
      submit: "Send RSVP",
      saving: "Saving…",
      success: "Thank you. Your RSVP has been saved and can be updated from this same link.",
    },
    footer: {
  ...
  es: {
    ...
    rsvp: {
      ...
      honeypot: "Sitio web",
      codeTitle: "Abre tu invitación personal",
      codeHelp: "Escribe el código incluido en el mensaje de invitación que te enviamos.",
      codeLabel: "Código de invitación",
      codeSubmit: "Abrir invitación",
      loading: "Estamos preparando tu invitación…",
      loadError: "No pudimos cargar esta invitación.",
      saveError: "No pudimos guardar tu confirmación.",
      invitationFor: "Invitación para",
      spacesReserved: "Hemos reservado {count} lugares para ustedes.",
      spacesUsed: "{used} de {max} lugares",
      editHelp: "Pueden modificar su respuesta desde este mismo enlace.",
      attendanceLabel: "Asistencia",
      attendanceYes: "Sí, asistiré",
      attendanceNo: "Lamento no poder asistir",
      whoAttends: "¿Quiénes asistirán?",
      guest: "Invitado",
      name: "Nombre",
      email: "Email",
      emailPlaceholder: "Opcional",
      dietary: "Restricciones alimentarias",
      dietaryPlaceholder: "Alergias o necesidades alimentarias",
      isChild: "Este invitado es menor de edad",
      message: "Mensaje para nosotros",
      submit: "Enviar confirmación",
      saving: "Guardando…",
      success: "Gracias. Su confirmación quedó guardada y pueden actualizarla desde este mismo enlace.",
    },
    footer: {
